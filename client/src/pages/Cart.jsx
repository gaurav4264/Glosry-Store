...
const Cart = () => {
    ...
    // Determine the primary product category from the cart for frequently bought together (optional, but we'll use personal for now)
    const primaryProductId = cartArray.length > 0 ? cartArray[0]._id : null;
    ...
    return (
        <div>
            ...
            {/* Show Recommendations below the cart */}
            <div className="mt-16 pt-8 border-t border-gray-100">
                <Recommendations productId={primaryProductId} />
            </div>
        </div>
    )
}
