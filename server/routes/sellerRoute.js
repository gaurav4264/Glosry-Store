...
import { vendorLogin, isVendorAuth, vendorLogout, getVendorProducts, getVendorOrders, deleteVendorProduct, updateVendorOrderStatus, vendorAddProduct, vendorLowStockAlerts, vendorUpdateProduct } from '../controllers/sellerApplicationController.js';
...
sellerRouter.post('/vendor-update-product', upload.array('images'), authVendor, vendorUpdateProduct);
